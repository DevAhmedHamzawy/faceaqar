  ...
  <div class="col-sm-12 col-xs-12 local-test local-test-forl">
     ...
     <div class="col-md-4">
        <div class="row">
            ...
            <div class="col-md-8">
                <input type="text" name="schema_name" value="{{ $local_auction_estate->schema_name }}" class="form-control" id="" placeholder=" اسم المخطط ">
            </div>
        </div>
      </div>
     <div class="col-md-4">
        <div class="row">
            ...
            <div class="col-md-8">
                <input type="number" name="schema_number" value="{{ $local_auction_estate->schema_number }}" class="form-control" id="" placeholder=" اكتب رقم ">
            </div>
        </div>
      </div>
     <div class="col-md-4">
        <div class="row">
            ...
            <div class="col-md-8">
                <input type="number" name="block_number" value="{{ $local_auction_estate->block_number }}" class="form-control required" id="" placeholder=" رقم البلوك ">
            </div>
        </div>
      </div>
     <div class="col-md-4">
        <div class="row">
            ...
            <div class="col-md-8">
                <input type="number" name="piece_number" value="{{ $local_auction_estate->piece_number }}" class="form-control required" id="" placeholder=" رقم القطعة ">
            </div>
        </div>
      </div>
     <div class="col-md-4">
            ...
            <div class="col-md-8">
                <select class="form-control required" name="destination_id">
                    ...
                    @foreach ($destinations as $destination)
                        <option value="{{ $destination->id }}" @if($local_auction_estate->destination_id == $destination->id) selected @endif>{{ $destination->name }}</option>
                    @endforeach
                </select>
            </div>
        </div>
     ...
     <div class="col-md-4">
        <div class="row">
            ...
            <div class="col-md-8">
                <input type="number" name="estate_space" value="{{ $local_auction_estate->estate_space }}" class="form-control required" id="" placeholder="  مساحة العقار م٢ ">
            </div>
        </div>
      </div>
     <div class="col-md-4">
        <div class="row">
            ...
            <div class="col-md-8">
                <input type="number" name="price" value="{{ $local_auction_estate->price }}"  class="form-control" id="" placeholder=" سعر العقار ">
            </div>
        </div>
     </div>
            ...
            <div class="col-md-8">
                <select class="form-control required" name="price_sort_id">
                    ...
                    @foreach ($priceSorts as $priceSort)
                        <option value="{{ $priceSort->id }}" @if($local_auction_estate->price_sort_id == $priceSort->id) selected @endif>{{ $priceSort->name }}</option>
                    @endforeach
                </select>
            </div>
        </div>
            ...
            <div class="col-md-8">
                <select class="form-control required" name="payment_sort_id">
                    ...
                    @foreach ($paymentSorts as $paymentSort)
                        <option value="{{ $paymentSort->id }}" @if($local_auction_estate->payment_sort_id == $paymentSort->id) selected @endif>{{ $paymentSort->name }}</option>
                    @endforeach
                </select>
            </div>
        </div>
            ...
            <div class="reveal-if-active" id="moreinaq">
                 ...
                 <div class="col-md-4">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <input type="number" name="building_space" value="{{ $local_auction_estate->building_space }}" class="form-control" id="" placeholder="مساحة البناء م٢">
                            </div>
                        </div>
                 </div>
                 <div class="col-md-4">
                 ...
                 <div class="col-md-4">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <input type="number" name="age" value="{{ $local_auction_estate->age }}" class="form-control" id="" placeholder="عمر العقار">
                            </div>
                        </div>
                 </div>
                 <div class="col-md-4">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <input type="number" name="floors_number" value="{{ $local_auction_estate->floors_number }}" min="0" id="">
                        </div>
                    </div>
                 </div>
                 <div class="col-md-4">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <input type="number" name="units_number" value="{{ $local_auction_estate->units_number }}" min="0" id="">
                        </div>
                    </div>
                 </div>
                 <div class="col-md-4">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <input type="number" name="floor_number" value="{{ $local_auction_estate->floor_number }}" min="0" id="">
                        </div>
                    </div>
                 </div>
                 <div class="col-md-4">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <input type="number" name="unit_number" value="{{ $local_auction_estate->unit_number }}" min="0" id="">
                        </div>
                    </div>
                 </div>
                 <div class="col-md-4">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <input type="number" name="rooms_number" value="{{ $local_auction_estate->rooms_number }}" min="0" id="">
                        </div>
                    </div>
                 </div>
                 <div class="col-md-4">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <input type="number" name="receptions_number" value="{{ $local_auction_estate->receptions_number }}" min="0" id="">
                        </div>
                    </div>
                 </div>
                 <div class="col-md-4">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <input type="number" name="kitchens_number" value="{{ $local_auction_estate->kitchens_number }}" min="0" id="">
                        </div>
                    </div>
                 </div>
                 <div class="col-md-4">
                     <div class="row">
                        ...
                        <div class="col-md-8">
                            <input type="number" name="stores_number" value="{{ $local_auction_estate->stores_number }}" min="0" id="">
                        </div>
                    </div>
                 </div>
                 <div class="col-md-4">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <input type="number" name="bathrooms_number" value="{{ $local_auction_estate->bathrooms_number }}" min="0" id="">
                        </div>
                    </div>
                 </div>
                 <div class="col-md-4">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <input type="number" name="lifts_number" value="{{ $local_auction_estate->lifts_number }}" min="0" id="">
                        </div>
                    </div>
                 </div>
                 <div class="col-md-4">
