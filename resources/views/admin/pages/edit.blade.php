...
@section('content')
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                  <div class="card-header"> <h5 class="text-center">{{ $mainPage->title }} تعديل صفحة {{ $page->title }} لقسم</h5> </div>
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('pages.store', [$page->id ,$mainPage->id]) }}">
                            @csrf
                            @method('patch')
